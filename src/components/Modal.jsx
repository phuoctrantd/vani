                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-body">
                                <div className="col" />
                                <button type="button" className="col btnclose" data-dismiss="modal" aria-label="Close" onClick={() => {
              setOpenModal(0);
            }}>
                                ...
                                <div className="barcode"><img src={`https://img.giftpop.vn/barcode.php?barcode=${voucher_id}&mode=3`} width={280} height={200} /></div><div className="barcodeNum ">999286175636</div>
                                ...
                                <button type="button" className="btnnut" data-dismiss="modal" onClick={() => {
              setOpenModal(2);
            }} >Nhân viên xác
                                    nhận</button>
                            </div>
